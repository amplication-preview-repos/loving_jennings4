...
export class TeamResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Rank], { name: "ranks" })
  @nestAccessControl.UseRoles({
    resource: "Rank",
    action: "read",
    possession: "any",
  ...
  async findRanks(
    ...
    @graphql.Args() args: RankFindManyArgs
  ): Promise<Rank[]> {
    const results = await this.service.findRanks(parent.id, args);
  ...
  async getSport(@graphql.Parent() parent: Team): Promise<Sport | null> {
